---
layout: post
title: Build A CI CD Pipeline On Azure Guide
---
...
![architecture diagram](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/Architecture.png)
...
![ssh keygen](../../../assets/images/2020-12-1-Build-A-CI-CD-Pipeline/sshkeygen.png)
...
![GitHub Setting](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/GitHubSetting.png)
...
![activate env](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/activateenv.png)
...
![make all](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/makeall.png)
...
![run python app](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/runpythonapp.png)

![local host browser](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/localhostbrowser.png)
...
![ml api](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/mlapi.png)
...
![Github clone project](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/GithubCloneProject.png)
  ...
  build:
    ...
    - name: Test with pytest
      run: |
        make test
```
![install](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/install.png)
![lint build test](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/buildandtest.png)
![clear run](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/clearrun.png)
...
![locust load test](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/locust.png)
...
![authorize web app](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/authorizewebapp.png)

![app service is ready](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/appserviceisready.png)
...
![successdeploywithazurepipeline](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/successdeploywithazurepipeline.png)

Go to the App Service, and click the URL under the Essentials , we should be able to visit the website now. 

![app service](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/appservice.png)
...
![azure prediction](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/azureprediction.png)
...
![modify triggers](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/modifytriggers.png)

![trigger by changes](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/triggerbychanges.png)
...
![logfiles](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/logfiles.png)
View the log file in App Service - Log Stream
![logfiles](../../../assets/./images/2020-12-1-Build-A-CI-CD-Pipeline/logstream.png)
## Enhancements
